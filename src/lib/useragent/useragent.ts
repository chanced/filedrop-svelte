...
export class UserAgent implements IResult {
  ...
  get isSmartTV(): boolean {
    ...
    return (this._cache.isSmartTV =
      this.device.type?.toLowerCase() === "smarttv");
  }
  get isConsole(): boolean {
    ...
    return (this._cache.isConsole =
      this.device.type?.toLowerCase() === "console");
  }
  get isWearable(): boolean {
    ...
    return (this._cache.isWearable =
      this.device.type?.toLowerCase() === "wearable");
  }
  get isMobileSafari(): boolean {
    ...
    return (this._cache.isMobileSafari =
      this.browser.name?.toLowerCase() === "mobile safari");
  }
  get isChromium(): boolean {
    if (this._cache.isChromium !== undefined) {
      return this._cache.isChromium;
    }
    return (this._cache.isChromium = this.browser.name
      ?.toLowerCase()
      .includes("chromium"));
  }
  get isMobile(): boolean {
    ...
    return (this._cache.isMobile =
      this.device.type?.toLowerCase() === "mobile");
  }
  ...
  get isTablet(): boolean {
    ...
    return (this._cache.isTablet =
      this.device.type?.toLowerCase() === "tablet");
  }
  ...
  get isChrome(): boolean {
    ...
    return (this._cache.isChrome =
      this.browser.name?.toLowerCase() === "chrome");
  }
  get isIE(): boolean {
    ...
    return (this._cache.isIE =
      browserName === "ie" || browserName === "internet explorer");
  }
  get isSafari(): boolean {
    if (this._cache.isSafari !== undefined) {
      return this._cache.isSafari;
    }
    return (this._cache.isSafari = this.browser.name
      ?.toLowerCase()
      .includes("safari"));
  }
  ...
  get isYandex(): boolean {
    ...
    return (this._cache.isYandex =
      this.browser.name?.toLowerCase() === "yandex");
  }
  get isMacOs(): boolean {
  ...
  get isSamsungBrowser(): boolean {
    ...
    return (this._cache.isOpera =
      this.browser.name?.toLowerCase() === "samsung browser");
  }
}
